...
var questions = [
  ...
  { 
    q: "Man kan også gjøre regneoperasjoner. Si du ønsker å vite hvor mye alt på handlelista koster. Vi tar en snarvei og antar at hver vare koster 30kr. Skriv ferdig koden esimatePrice() for å regne ut et estimat på hva du må betale🧠", 
    startValue: "function estimatePrice(shoppingListNumber){\n let priceForEachItem = 30;\n let totalCost = /*dine kode her*/;\n return totalCost +\n ' kroner for alt du skal ha';\n} ",
    test: function test(input){
      let testNum = 5;
      ...
      if (eval(input + "estimatePrice(1);") !== '30 kroner for alt du skal ha'){
        return false;
        }
      return true;
